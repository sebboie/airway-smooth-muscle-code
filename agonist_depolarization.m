...
par      = [ip3; 50; influx; open; gCa; gSocc];
[t2, z]  = ode23s(@(t,x) asmc(t,x,par), [0 200], y(end,:));
save('data/agonist_depolarization.mat', 'y');
save('data/agonist_depolarization.mat', 't1','-append');
save('data/agonist_depolarization.mat', 't2', '-append');
save('data/agonist_depolarization.mat', 'z', '-append');
clf;
figure(1);
subplot(2,1,1)
