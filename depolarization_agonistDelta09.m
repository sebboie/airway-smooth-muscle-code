...
save('data/depolarization_agonistDelta09.mat', 'y');
save('data/depolarization_agonistDelta09.mat', 't1', '-append');
save('data/depolarization_agonistDelta09.mat', 't2', '-append');
save('data/depolarization_agonistDelta09.mat', 'z', '-append');
